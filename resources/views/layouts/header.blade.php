...
<div class="d-flex flex-column justify-content-center align-content-center overlay-nav" id="myNav">
    <div class="d-flex flex-column justify-content-center align-items-center" id="content-nav">
        ...
        <div class="d-flex flex-column align-items-center overlay-content"><a href="http://legal.raahifrafeeu.com/">Home</a><a href="{{route('partners')}}">Partners</a><a href="{{route('areas')}}">Practice Areas</a><a href="{{route('values')}}">Our Core Values</a><a href="{{route('bots')}}">Legal Bots</a><a href="#">The Start-up Lawyers </a><a href="{{route('publications')}}">Publications</a><a href="{{'admin'}}">Clientio</a></div>
    </div>
</div>
